...
*//*                while (sr.Read())
            ...
            for (int i = 0; i < fileName.Length; i++)
            {
                ...
                cmd.CommandText = "SELECT crashes FROM data WHERE datadate = '" + Date + "' and drivername = 'rltkapo64.dll' and releaseversion = '1909 | 19H2' ";
        ...
        public static void CreateSet()
        {
            ...
            for (int i = 0; i < fileName.Length; i++)
            {
                ...
                string v = Date.Replace("-", "");
                //创建数据表      "+ "D" + v +" 
                SQLiteCommand cmd = new SQLiteCommand("CREATE TABLE IF NOT EXISTS data( datadate varchar(10),driverversion varchar(20), drivername varchar(20),osversion varchar(20)," +
